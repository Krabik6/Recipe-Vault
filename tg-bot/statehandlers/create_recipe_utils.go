...
//getting and setting jwt key by user id
...
func (crs *CreateRecipeStateHandler) SetUserState(ctx context.Context, userID int64) error {
	state, err := crs.State.MarshalBinary()
	if err != nil {
		return err
	}
...
func (crs *CreateRecipeStateHandler) DeleteUserState(ctx context.Context, userID int64) error {
	key := fmt.Sprintf(createRecipeStateKey, userID)
...
func (crs *CreateRecipeStateHandler) GetUserState(ctx context.Context, userID int64) (createRecipeState, error) {
	key := fmt.Sprintf(createRecipeStateKey, userID)
...
func (crs *CreateRecipeStateHandler) SetUserData(ctx context.Context, userID int64) error {
...
func (crs *CreateRecipeStateHandler) DeleteUserData(ctx context.Context, userID int64) error {
	keyTitle := fmt.Sprintf(createRecipeTitleKey, userID)
...
func (crs *CreateRecipeStateHandler) GetUserData(ctx context.Context, userID int64) (title string, description string, isPublic bool, cost float64, timeToPrepare int64, healthy int, err error) {
	keyTitle := fmt.Sprintf(createRecipeTitleKey, userID)
